package uni.freiburg.sp.config;

import org.streampipes.config.SpConfig;
import org.streampipes.container.model.PeConfig;

import static uni.freiburg.sp.config.ConfigKeys.*;
...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID= "pe/uni.freiburg.sp";

  Config() {
    config = SpConfig.getSpConfig("pe/uni.freiburg.sp");

    config.register(HOST, "SPAnnotationDetection", "Hostname for the pe sinks");
